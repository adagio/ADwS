 ...
 */
let walkingChallenges = ["walk 3 miles a day", "walk 2 times a week"]
let runningChallenges = ["run 5 times a week", "run 42 km a week"]
...
if userChallenges.isEmpty {
    ...
    print("The challege you have chosen is \(userChallenges[0])")
} else {
